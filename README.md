<div style="background-color: #0b0f19; padding: 25px; border-radius: 12px; border: 1px solid #00ffcc55; font-family: 'Share Tech Mono', monospace;">
  ...
  <p align="center" style="color: #00ffcc; font-size: 13px; letter-spacing: 2px; margin-top: 15px; text-shadow: 0 0 8px rgba(0,255,204,0.4);">
    ⚡ POWERED BY FANKAR-TECH• ULTIMATE EXPERIENCE ⚡
  </p>
...
🛡•••FANKAR-MD is a WhatsApp MD bot built on top of the Baileys library. It is designed to be fast, lightweight, and easy to customize without touching the core code. This project is fully {open source} — you are free to modify it, rebrand it, and create your own bot from this codebase for free, without needing any permission from anyone. All commands such as menu, alive, antilink, play, sticker, and the overall structure are written in a way that makes customization as easy as possible😎.
